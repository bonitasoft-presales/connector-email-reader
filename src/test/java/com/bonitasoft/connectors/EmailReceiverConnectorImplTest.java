...
public class EmailReceiverConnectorImplTest {
    ...
    void shouldReadMailWithAttachments() throws Exception {
        ...
        String from = "Walter Bates<walter.bates@acme.com>";
        ...
        assertThat(firstMessage.get("name")).as("should have a sender name").isEqualTo("Walter Bates");
        assertThat(firstMessage.get("from")).as("should have a sender email").isEqualTo("walter.bates@acme.com");
